        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Charges at Nexura</a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Nexura IDFC FIRST Bank 3-in-1 Account</a>
                    <br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=""><i class="fa fa-user" aria-hidden="true"></i> Your Nexura Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=""><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Nexura Account</h4>
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Stockports++</a>
                    <br />
